...
public class HmacSecurityFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            //if url is /api/authenicate
            if (!hmacRequester.canVerify(request)) {//canverify=request url contains /api and doesn't contain /api/authenticate = true
                ...
                if (digestClient.equals(digestServer)) {
                    ...
                    HmacToken hmacToken = HmacSigner.getSignedToken(secret,iss,JWT_TTL,customClaims);
